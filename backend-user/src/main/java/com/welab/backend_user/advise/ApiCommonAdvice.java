...
import com.welab.backend_user.advise.parameter.ParameterErrorDto;
...
public class ApiCommonAdvice {
    ...
    public ApiResponseDto<String> handlerBadParameter(BadParameter e) {
    ...
    public ApiResponseDto<String> handlerNotFound(NotFound e) {
        return ApiResponseDto.createError(
                e.getErrorCode(),
                e.getErrorMessage()
        );
